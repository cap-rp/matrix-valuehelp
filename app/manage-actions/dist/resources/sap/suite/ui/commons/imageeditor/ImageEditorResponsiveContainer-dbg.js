...
sap.ui.define([
	...
	"sap/ui/core/Lib"
], function(ImageEditorContainer, ImageEditorContainerRenderer, Device, Button, Dialog, Bar, Title, ControlProxy, CoreLib) {
	"use strict";
				...
				customHeader: new Bar({
					...
					contentRight: [
						new Button({
							...
							tooltip: oResourceBundle.getText("IMGEDITOR_DIALOG_CLOSE"),
							press: function() {
								that._oDialog.close();
							}
						})
