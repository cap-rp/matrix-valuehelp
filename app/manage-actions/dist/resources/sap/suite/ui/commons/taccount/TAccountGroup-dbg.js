...
sap.ui.define([
	...
	"sap/ui/core/Lib",
	"sap/ui/core/Theming"
], function (jQuery, library, Control, Parameters, TAccountPanel, IconPool, Button, encodeXML, Configuration, ItemNavigation, TAccountUtils, ResizeHandler, BigNumber, InvisibleText, Core, CoreLib, Theming) {
	"use strict";
	...
	TAccountGroup.prototype._expandCollapse = function () {
		...
		this._getExpandCollapse().setIcon(bCollapsed ? "sap-icon://navigation-down-arrow" : "sap-icon://navigation-right-arrow");
