...
sap.ui.define([
	...
	"./CustomShapeRenderer",
	"sap/m/library"
], function (jQuery, library, ShapeGroup, Shape, Path, Circle, Rectangle, HtmlElement, Log, CustomShapeRenderer, MobileLibrary) {
	"use strict";
		...
		/** @lends sap.suite.ui.commons.statusindicator.Shape.prototype */
		{
			metadata: {
				...
				properties: {
					 ...
					 */
					strokeColor: {type: "string", defaultValue: "Neutral"},
	...
	CustomShape.prototype.setStrokeColor = function(sValue, bSuppressInvalidate) {
		...
		if ( sValue != null && !bIsValueSet ) {
			throw new Error(`Value ${sValue} is not valid for property "strokeColor"`);
		 }

		return this.setProperty("strokeColor", bIsValueSet ? sValue : null, bSuppressInvalidate);
	};
