...
sap.ui.define([
	...
	"sap/ui/core/Lib",
	"sap/ui/Device"
], function (library, CoreLib, Device) {
	"use strict";
	...
	return {
		...
		_writeAriaTags: function (oRM, oNetworkGraph) {
			...
			oRM.attr("aria-roledescription", oResourceBundle.getText("NETWORK_GRAPH_ACCESSIBILITY_LABEL"));
			oRM.attr("aria-description", oResourceBundle.getText("NETWORK_GRAPH_ACCESSIBILITY_DESCRIPTION"));
