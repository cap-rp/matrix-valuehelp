...
sap.ui.define([
	...
	CalculationBuilderItem.prototype._getItemInstance = function (sType, sCollectionName) {
		if (this._getType() === sType) {
			...
			var aCollection;
			var oCalculationBuilder = this.getParent();
			switch (sCollectionName) {
				case "getVariables":
					aCollection = oCalculationBuilder?._mVariableMap;
					break;
				case "getFunctions":
					aCollection = oCalculationBuilder?._mFunctionMap;
					break;
				case "getOperators":
					aCollection = oCalculationBuilder?._mOperatorMap;
					break;
				default:
					aCollection = {};
					break;
			}
			return (aCollection) ? aCollection[sKey] : null;
		}
