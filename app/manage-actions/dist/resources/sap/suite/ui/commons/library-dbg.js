...
sap.ui.define([
	...
	var oSuiteCommonsLib = Lib.init({
		...
		types: [
			...
			"sap.suite.ui.commons.SemanticColorType",
	 ...
	 */
	DataType.registerEnum("sap.suite.ui.commons.BulletChartMode", oSuiteCommonsLib.BulletChartMode);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.CommonBackground", oSuiteCommonsLib.CommonBackground);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.ComparisonChartView", oSuiteCommonsLib.ComparisonChartView);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderComparisonOperatorType", oSuiteCommonsLib.CalculationBuilderComparisonOperatorType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderFunctionType", oSuiteCommonsLib.CalculationBuilderFunctionType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderItemType", oSuiteCommonsLib.CalculationBuilderItemType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderLogicalOperatorType", oSuiteCommonsLib.CalculationBuilderLogicalOperatorType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderLayoutType", oSuiteCommonsLib.CalculationBuilderLayoutType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderOperatorType", oSuiteCommonsLib.CalculationBuilderOperatorType);
	...
	DataType.registerEnum("sap.suite.ui.commons.CalculationBuilderValidationMode", oSuiteCommonsLib.CalculationBuilderValidationMode);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.DeviationIndicator", oSuiteCommonsLib.DeviationIndicator);
	...
	/**
	 * @deprecated As of version 1.32.
	 */
	DataType.registerEnum("sap.suite.ui.commons.FacetOverviewHeight", oSuiteCommonsLib.FacetOverviewHeight);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.FrameType", oSuiteCommonsLib.FrameType);
	 ...
	 */
	DataType.registerEnum("sap.suite.ui.commons.HeaderContainerView", oSuiteCommonsLib.HeaderContainerView);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.InfoTileSize", oSuiteCommonsLib.InfoTileSize);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.InfoTileTextColor", oSuiteCommonsLib.InfoTileTextColor);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.InfoTileValueColor", oSuiteCommonsLib.InfoTileValueColor);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.LoadState", oSuiteCommonsLib.LoadState);
	 ...
	 * @deprecated As of version 1.34.
	 */
	DataType.registerEnum("sap.suite.ui.commons.MicroAreaChartView", oSuiteCommonsLib.MicroAreaChartView);
	...
	DataType.registerEnum("sap.suite.ui.commons.MicroProcessFlowRenderType", oSuiteCommonsLib.MicroProcessFlowRenderType);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.BackgroundColor", oSuiteCommonsLib.networkgraph.BackgroundColor);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.ActionButtonPosition", oSuiteCommonsLib.networkgraph.ActionButtonPosition);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.NodeShape", oSuiteCommonsLib.networkgraph.NodeShape);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.NodePlacement", oSuiteCommonsLib.networkgraph.NodePlacement);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.ElementStatus", oSuiteCommonsLib.networkgraph.ElementStatus);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.RenderType", oSuiteCommonsLib.networkgraph.RenderType);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.LineArrowOrientation", oSuiteCommonsLib.networkgraph.LineArrowOrientation);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.LayoutRenderType", oSuiteCommonsLib.networkgraph.LayoutRenderType);
	...
	DataType.registerEnum("sap.suite.ui.commons.networkgraph.HeaderCheckboxState", oSuiteCommonsLib.networkgraph.HeaderCheckboxState);
	...
	oSuiteCommonsLib.SemanticColorType = {
	...
	DataType.registerEnum("sap.suite.ui.commons.SemanticColorType", oSuiteCommonsLib.SemanticColorType);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowConnectionLabelState", oSuiteCommonsLib.ProcessFlowConnectionLabelState);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowConnectionState", oSuiteCommonsLib.ProcessFlowConnectionState);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowConnectionType", oSuiteCommonsLib.ProcessFlowConnectionType);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowDisplayState", oSuiteCommonsLib.ProcessFlowDisplayState);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowLaneState", oSuiteCommonsLib.ProcessFlowLaneState);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowNodeState", oSuiteCommonsLib.ProcessFlowNodeState);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowNodeType", oSuiteCommonsLib.ProcessFlowNodeType);
	...
	DataType.registerEnum("sap.suite.ui.commons.ProcessFlowZoomLevel", oSuiteCommonsLib.ProcessFlowZoomLevel);
	 ...
	 * @deprecated As of version 1.48.
	 */
	DataType.registerEnum("sap.suite.ui.commons.SelectionState", oSuiteCommonsLib.SelectionState);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.FillingDirectionType", oSuiteCommonsLib.statusindicator.FillingDirectionType);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.HorizontalAlignmentType", oSuiteCommonsLib.statusindicator.HorizontalAlignmentType);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.VerticalAlignmentType", oSuiteCommonsLib.statusindicator.VerticalAlignmentType);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.SizeType", oSuiteCommonsLib.statusindicator.SizeType);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.LabelPositionType", oSuiteCommonsLib.statusindicator.LabelPositionType);
	...
	DataType.registerEnum("sap.suite.ui.commons.statusindicator.FillingType", oSuiteCommonsLib.statusindicator.FillingType);
	...
	DataType.registerEnum("sap.suite.ui.commons.taccount.TAccountPanelState", oSuiteCommonsLib.taccount.TAccountPanelState);
	 ...
	 * @deprecated As of version 1.32.
	 */
	DataType.registerEnum("sap.suite.ui.commons.ThingGroupDesign", oSuiteCommonsLib.ThingGroupDesign);
	...
	DataType.registerEnum("sap.suite.ui.commons.TimelineAlignment", oSuiteCommonsLib.TimelineAlignment);
	...
	DataType.registerEnum("sap.suite.ui.commons.TimelineAxisOrientation", oSuiteCommonsLib.TimelineAxisOrientation);
	...
	DataType.registerEnum("sap.suite.ui.commons.TimelineFilterType", oSuiteCommonsLib.TimelineFilterType);
	...
	DataType.registerEnum("sap.suite.ui.commons.TimelineGroupType", oSuiteCommonsLib.TimelineGroupType);
	...
	/**
	 * @deprecated As of version 1.54.0.
	 */
	DataType.registerEnum("sap.suite.ui.commons.TimelineScrollingFadeout", oSuiteCommonsLib.TimelineScrollingFadeout);
	 ...
	 * @deprecated As of version 1.32.
	 */
	DataType.registerEnum("sap.suite.ui.commons.ValueStatus", oSuiteCommonsLib.ValueStatus);
	...
	DataType.registerEnum("sap.suite.ui.commons.ImageEditorMode", oSuiteCommonsLib.ImageEditorMode);
	...
	DataType.registerEnum("sap.suite.ui.commons.ImageEditorContainerMode", oSuiteCommonsLib.ImageEditorContainerMode);
	...
	DataType.registerEnum("sap.suite.ui.commons.ImageFormat", oSuiteCommonsLib.ImageFormat);
	...
	DataType.registerEnum("sap.suite.ui.commons.ImageEditorContainerButton", oSuiteCommonsLib.ImageEditorContainerButton);
	...
	DataType.registerEnum("sap.suite.ui.commons.FilePickerModes", oSuiteCommonsLib.FilePickerModes);
	 ...
	 * @public
	 */
	oSuiteCommonsLib.FilePickerType = {
		/**
	...
	DataType.registerEnum("sap.suite.ui.commons.FilePickerType", oSuiteCommonsLib.FilePickerType);
	...
	DataType.registerEnum("sap.suite.ui.commons.SelectionModes", oSuiteCommonsLib.SelectionModes);
