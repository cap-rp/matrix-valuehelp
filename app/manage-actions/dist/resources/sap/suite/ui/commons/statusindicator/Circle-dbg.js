...
sap.ui.define([
	...
	function (Shape,HtmlElement, SimpleShape, SimpleShapeRenderer, lib, MobileLibrary) {
		"use strict";
		...
		Circle.prototype._getSimpleShapeElement = function (sCircleId) {
			...
			if (oSemanticColorType.hasOwnProperty(sStrokeColor)) {
				oCircleElement.addClass("strokeSemanticColor" + sStrokeColor);
			}
			/** @deprecated since 1.135 */
			if (ValueCssColor.isValid(sStrokeColor)){
				oCircleElement.setAttribute("stroke", sStrokeColor);
			}
