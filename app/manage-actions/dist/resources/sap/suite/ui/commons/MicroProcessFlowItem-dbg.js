...
sap.ui.define([
	...
	"sap/ui/core/Lib"
], function (jQuery, library, CoreLibrary, Control, MicroProcessFlow, CoreLib) {
	"use strict";
	...
	var MicroProcessFlowItem = Control.extend("sap.suite.ui.commons.MicroProcessFlowItem", {
		...
		renderer: {
			...
			if (oCustomControl) {
				...
				oRM.attr("aria-roledescription", `${oMicroProcessFlowItem._iIndex} of ${oMicroProcessFlowItem._iItemsCount}`);
