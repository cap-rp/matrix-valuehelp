...
sap.ui.define([
	...
	"sap/ui/core/Lib"
], function (jQuery, library, Control, CalculationBuilderItem, CalculationBuilderExpression, CalculationBuilderInput, CalculationBuilderFunction, CalculationBuilderVariable, CalculationBuilderGroup,
				OverflowToolbar, OverflowToolbarToggleButton, OverflowToolbarButton, ToolbarSpacer, Title, MessageBox, Log, uid, coreLibrary, mLibrary, FullScreenUtil, CoreLib) {
	"use strict";
	...
	CalculationBuilder.prototype._findInChildren = function (sKey, sType) {
		var mCollection;
		switch (sType) {
			case "Variable":
				mCollection = this._oExpressionBuilder._mVariableMap;
				break;
			case "Function":
				mCollection = this._oExpressionBuilder._mFunctionMap;
				break;
			case "Operator":
				mCollection = this._oExpressionBuilder._mOperatorMap;
				break;
			default:
				mCollection = {};
				break;
		}
		return mCollection[sKey.toLowerCase()];
	};
	...
	CalculationBuilder.prototype._getType = function (sKey) {
		...
		if (this._findInChildren(sKey, "Variable")) {
