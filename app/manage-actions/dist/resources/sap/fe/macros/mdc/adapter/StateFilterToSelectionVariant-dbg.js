 ...
 */
sap.ui.define(["sap/base/Log", "sap/base/util/isEmptyObject", "sap/fe/macros/filterBar/SemanticDateOperators", "sap/fe/navigation/SelectionVariant", "sap/ui/mdc/condition/FilterOperatorUtil", "sap/ui/mdc/condition/RangeOperator", "sap/ui/mdc/odata/v4/TypeMap"], function (Log, isEmptyObject, SemanticDateOperators, SelectionVariant, FilterOperatorUtil, RangeOperator, TypeMap) {
  "use strict";
  ...
  const stateFilterToSelectionVariant = {
    ...
    createSemanticDatesFromConditions: function (condition) {
      if (!isEmptyObject(condition)) {
        return {
          high: condition.values[0] !== undefined && condition.values[0] !== null ? condition.values[0] : null,
          low: condition.values[1] !== undefined && condition.values[1] !== null ? condition.values[1] : null,
...
//# sourceMappingURL=StateFilterToSelectionVariant-dbg.js.map
