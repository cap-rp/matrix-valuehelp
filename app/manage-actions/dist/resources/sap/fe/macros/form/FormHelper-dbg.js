 ...
 */
sap.ui.define(["sap/fe/core/helpers/ModelHelper", "sap/ui/core/library"], function (ModelHelper, library) {
  "use strict";
  ...
  const FormHelper = {
     ...
     */
    create$Select: function (semanticKeys, secondaryKeys) {
      let keys = "";
     ...
     */
    generateBindingExpression: function (navigationPath, dataModelObjectPath) {
      ...
      if (semanticKeys || alternateAndSecondaryKeys?.length) {
        binding.parameters = {
          $select: FormHelper.create$Select(semanticKeys, alternateAndSecondaryKeys)
        };
      }
...
//# sourceMappingURL=FormHelper-dbg.js.map
