...
sap.ui.define([
	...
	function(Log, UIComponent, commonsLibrary, View, ViewType) {
	"use strict";
	...
	*
	* @public
	* @alias sap.collaboration.components.feed.Component
	*/
		...
		*/
		...
		_setProperty: function(propertyName, propertyValue) {
			...
			if (this._view){
				...
				this.viewPromise.then((oView) => {
					oView.getModel().setProperty("/" + propertyName, propertyValue);
					this.setProperty(propertyName, propertyValue);
				});	
			}
		},
