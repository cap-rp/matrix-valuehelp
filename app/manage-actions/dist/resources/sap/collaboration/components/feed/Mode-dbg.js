...
sap.ui.define([
	...
	var Mode = BaseObject.extend("sap.collaboration.components.feed.Mode", {
		constructor: function(oFeedController) {
			...
			this.groupSelectorLoaded = Fragment.load({
				id: sGroupSelectorFragmentId,
				name: "sap.collaboration.components.feed.fragments.GroupSelector",
				controller: this
			}).then( (oGroupSelector) => {
...
//			construct the custom list item fragment, binding will be done in each mode
			this._oListItemTemplate = Fragment.load({
